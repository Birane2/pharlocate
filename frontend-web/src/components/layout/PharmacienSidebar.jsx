...
const navItems = [
  ...
  { label: "Reservations", path: "/pharmacien/reservations", icon: faCalendarCheck },
...
function PharmacienNavLink({ item, mobile = false }) {
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        mobile
          ? `group flex flex-col items-center justify-center gap-1 rounded-xl px-1 py-2 text-[10px] font-bold transition duration-200 ${
              isActive
