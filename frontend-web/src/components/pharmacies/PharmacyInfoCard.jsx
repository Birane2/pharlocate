  ...
  return (
    ...
    >
      <div className="grid gap-0 lg:grid-cols-[0.7fr_1.3fr]">
        <div className="relative min-h-[190px] bg-[linear-gradient(145deg,_rgba(47,110,158,0.98),_rgba(47,166,163,0.92))]">
          {photoUrl ? (
            <img src={photoUrl} alt={pharmacy.nom} className="h-full w-full object-cover" />
          ) : (
            <div className="flex h-full min-h-[190px] items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.18),_transparent_35%),linear-gradient(145deg,_rgba(47,110,158,0.98),_rgba(47,166,163,0.92))] p-6 text-white">
        ...
        <div className="space-y-4 p-5 sm:p-6">
          ...
          <div>
            <h1 className="text-2xl font-black tracking-tight text-[#16324A] sm:text-3xl">
              {pharmacy.nom}
            </h1>
            <p className="mt-3 flex items-start gap-3 text-sm leading-6 text-pharmaTextLight">
